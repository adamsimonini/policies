export default function TermsAndConditions() {
  return (
    <div>
      ...
      <p>
        These terms and conditions apply to the Ultimate Fight Timer app (hereby referred to as "Application") for mobile
        devices that was created by Archon Capital Incorporated (hereby referred to as "Service Provider") as a Freemium
        service.
      </p>
      <br />
      <p>
      ...
      <br />
      <p>
        Unauthorized copying, modification of the Application, any part of the Application, or our trademarks is strictly
        prohibited. Any attempts to extract the source code of the Application, translate the Application into other
        languages, or create derivative versions are not permitted. All trademarks, copyrights, database rights, and other
      ...
      <br />
      <p>These terms and conditions are effective as of 2026-04-28</p>
