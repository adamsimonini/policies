export default function PrivacyPolicy() {
  return (
    <div>
      ...
      <p>
        This privacy policy applies to the Ultimate Fight Timer app (hereby referred to as
        "Application") for mobile devices that was created by Archon Capital Incorporated
        (hereby referred to as "Service Provider") as a Freemium service. This service is
      ...
      <p>
        ...
        certain personally identifiable information, including but not limited to Name, Email, Gender, Profession. The
        information that the Service Provider requests will be retained by them and used as described in this privacy policy.
      </p>
      ...
      <p>
        ...
        contact them at{' '}
        <a href="mailto:contact@fansync.ca">contact@fansync.ca</a> and they will respond in a reasonable time.
      </p>
      ...
      <p>
        ...
        <a href="mailto:contact@fansync.ca">contact@fansync.ca</a>) so that they will be able to take the necessary
        actions.
      </p>
      ...
      <br />
      <p>This privacy policy is effective as of 2026-04-28</p>
      ...
      <p>
        ...
        <a href="mailto:contact@fansync.ca">contact@fansync.ca</a>.
      </p>
    </div>
  )
}
